      ...
      <div className="absolute inset-0 overflow-y-auto">
        <div className="relative w-full">
          ...
          <button
            ...
            className="absolute left-[16px] top-[52px] z-20 flex h-[36px] w-[36px] items-center justify-center rounded-full bg-white/90 shadow-[0_2px_8px_rgba(0,0,0,0.08)] backdrop-blur-sm transition-transform active:scale-95"
          >
